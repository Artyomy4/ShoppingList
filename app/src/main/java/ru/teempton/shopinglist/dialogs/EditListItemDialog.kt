package ru.teempton.shopinglist.dialogs
...
import ru.teempton.shopinglist.databinding.EditListItemDialogBinding
import ru.teempton.shopinglist.databinding.NewListDialogBinding
        ...
        binding.apply {
            ...
            bUpdate.setOnClickListener {
                if (edName.text.toString().isNotEmpty()) {
                    listener.onClick(
                        item.copy(name = edName.text.toString(),
