...
import ru.teempton.shopinglist.activities.MainApp
import ru.teempton.shopinglist.activities.NewNoteActivity
import ru.teempton.shopinglist.databinding.FragmentNoteBinding
import ru.teempton.shopinglist.db.MainViewModel
import ru.teempton.shopinglist.db.NoteAdapter
...
class NoteFragment : BaseFragment(),NoteAdapter.Listener {
    ...
    private fun initRcView() = with(binding){
        defPreferences = activity?.let { PreferenceManager.getDefaultSharedPreferences(it) }!!
    ...
    private fun getLayoutManager():RecyclerView.LayoutManager{
        Log.d("MyLog", defPreferences.getString("note_style_key","Linear")!!)
