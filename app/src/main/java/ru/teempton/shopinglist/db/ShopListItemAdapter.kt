...
import ru.teempton.shopinglist.databinding.ShopLibraryListItemBinding
import ru.teempton.shopinglist.databinding.ShopListItemBinding
...
;                }
        ...
        private fun setPaintFlagAndColor(binding: ShopListItemBinding){
            binding.apply {
                if (chBox.isChecked){
                    ...
                    tvName.setTextColor(ContextCompat.getColor(binding.root.context,R.color.green_main_dark))
                    tvInfo.setTextColor(ContextCompat.getColor(binding.root.context,R.color.green_main_dark))
        ...
        private fun infoVisibility(shopListItem: ShopListItem):Int{
            return if (shopListItem.itemInfo.isNotEmpty()) {
                View.VISIBLE
            }else{
                View.GONE
            }
